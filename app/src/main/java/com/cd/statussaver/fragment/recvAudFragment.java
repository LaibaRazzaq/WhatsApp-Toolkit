...
public class recvAudFragment extends Fragment implements FileSizeListener {
    ...
    public recvAudFragment(List<Uri> recvList, String from) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_recv_aud, container, false);
