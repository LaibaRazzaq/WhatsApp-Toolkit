...
public class WhatsappDownVideoFrag extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private FileListAdapter fileListAdapter;
    private WhatsappDownVideoFrag VideoListAdapter;
    private ArrayList<File> fileArrayList,VideoFileArrayList;
            ...
            if (files!=null) {
                ...
                for (File file : files) {
                    if (file.getName().endsWith(".mp4")) {
                        ...
                        fileListAdapter = new FileListAdapter(activity,fileArrayList , WhatsappDownVideoFrag.this);
