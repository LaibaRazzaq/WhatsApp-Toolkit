...
import com.cd.statussaver.fragment.recvGifFragment;
import com.cd.statussaver.fragment.sendGifFragment;
...
public class WhatsAppGifs extends AppCompatActivity {
    ...
    String from;
    WhatsAppGifs activity;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_whats_app_gifs);

        setContentView(R.layout.activity_whats_app_images);
        admenager=new Admenager(this,this);
        admenager.load_InterstitialAd(getString(R.string.admobe_intertesial_whatsAppGif));
        Objects.requireNonNull(getSupportActionBar()).setTitle("GIFS");
    ...
    private void initViews() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
            ...
            if (ActivityCompat.checkSelfPermission(WhatsAppGifs.this,Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED&&ActivityCompat.checkSelfPermission(WhatsAppGifs.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)==PackageManager.PERMISSION_GRANTED){
                progressDialog.show();
                new LoadAllFiles().execute();
                tvAllowAccess.setVisibility(View.GONE);
            }else {
    ...
    private void requestPeemision() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
            ...
            ActivityCompat.requestPermissions(WhatsAppGifs.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE},21);
    ...
    class LoadAllFiles extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    Utils.handleData(WhatsAppGifs.this,treeUri, parentPath, recvImgList, "", false);
                    Utils.handleData(WhatsAppGifs.this,treeUri, parentPath, sendImgList, "Sent", true);
                }else {
                    ...
                    Utils.below10HandleImage(senList, sendImgList, true);
                }
            }catch (Exception e){
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(String s) {
            if (!isFinishing()){
                ...
                adapter.addFragment(new recvGifFragment(recvImgList, from), "Received");
                adapter.addFragment(new sendGifFragment(sendImgList,from),"Sent");
