...
import com.cd.statussaver.fragment.recvDocFragment;
import com.cd.statussaver.fragment.sendDocFragment;
...
public class WhatsappDoc extends AppCompatActivity {

    ViewPager viewPager;
    TabLayout tabLayout;
    List<Uri> sendDocList;
    List<Uri>  recvDocList;
    WhatsappDoc activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whatsapp_doc);
        admenager=new Admenager(this,this);
        admenager.load_InterstitialAd(getString(R.string.admobe_intertesial_whatsAppDoc));
        ...
        //iski parent activity pr ja rha tha yeh
        //abh alag sy kia
    ...
    class LoadAllFiles extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    Utils.handleData(WhatsappDoc.this, treeUri, parentPath, recvDocList, "", false);
                    Utils.handleData(WhatsappDoc.this, treeUri, parentPath, sendDocList, "Sent", true);
                } else {
        ...
        protected void onPostExecute(String s) {
            if (!isFinishing()){
                ...
                adapter.addFragment(new recvDocFragment(recvDocList, from), "Received");
                adapter.addFragment(new sendDocFragment(sendDocList,from),"Sent");
