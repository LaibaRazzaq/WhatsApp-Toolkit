...
import com.cd.statussaver.fragment.SizeFrgment;
import com.cd.statussaver.fragment.reciveImageFragment;
import com.cd.statussaver.fragment.sendImageFragment;
...
public class WhatsAppImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admenager.load_InterstitialAd(getString(R.string.admobe_intertesial_whatsAppImages));
    ...
    private void requestPeemision() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
            ...
            ActivityCompat.requestPermissions(WhatsAppImages.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE},21);
    ...
    class LoadAllFiles extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    Utils.handleData(WhatsAppImages.this,treeUri, parentPath, recvImgList, "", false);
                    Utils.handleData(WhatsAppImages.this,treeUri, parentPath, sendImgList, "Sent", true);
                }else {
        ...
        protected void onPostExecute(String s) {
            if (!isFinishing()){
                ...
                adapter.addFragment(new reciveImageFragment(recvImgList, from), "Received");
                adapter.addFragment(new sendImageFragment(sendImgList,from),"Sent");
