...
public class WhatsAppVideos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        admenager.load_InterstitialAd(getString(R.string.admobe_intertesial_whatsAppVideo));
    ...
    private void initViews() {
        ...
        sendVdList = new ArrayList<>();
        recvVdList = new ArrayList<>();
        initProgress();
    ...
    class LoadAllFiles extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    Utils.handleData(WhatsAppVideos.this,treeUri, parentPath, recvVdList, "", false);
                    Utils.handleData(WhatsAppVideos.this,treeUri, parentPath, sendVdList, "Sent", true);
                }else {
                    ...
                    recvVdList.clear();
                    sendVdList.clear();
                    Utils.below10HandleImage(recvList, recvVdList, false);
                    Utils.below10HandleImage(senList, sendVdList, true);
        ...
        protected void onPostExecute(String s) {
            if (!isFinishing()){
                ...
                adapter.addFragment(new reciveImageFragment(recvVdList, from), "Received");
                adapter.addFragment(new sendImageFragment(sendVdList,from),"Sent");
