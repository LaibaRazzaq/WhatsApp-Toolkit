...
import com.cd.statussaver.fragment.voiceFragment;
...
public class WhatsappVoice extends AppCompatActivity {


    Gson gson;
    List<Uri> sendList;
    List<Uri>  recvList;
    WhatsappVoice activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whatsapp_voice);
        admenager=new Admenager(this,this);
        admenager.load_InterstitialAd(getString(R.string.admobe_intertesial_whatsAppVoice));

        Objects.requireNonNull(getSupportActionBar()).setTitle("VoiceNotes");
    ...
    private void requestPeemision() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
            ...
            ActivityCompat.requestPermissions(WhatsappVoice.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE},21);
        ...
        protected String doInBackground(String... strings) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
                    ...
                    String parentPath=(from.equals("whatsapp")) ? "/Media/WhatsApp Voice Notes" : "/Media/WhatsApp Business Voice Notes";


                    Utils.handleVoiceNotes(treeUri,parentPath,recvList,WhatsappVoice.this);
                    ...
                    Utils.below10VoiceNote(recvList1, recvList, false);
            ...
            try {
                if (!isFinishing()){
                    ...
                    if (!fragmentManager.isDestroyed()){
                        fragmentManager.beginTransaction().replace(R.id.fragment_container_view, new voiceFragment(recvList, from)).commit();
